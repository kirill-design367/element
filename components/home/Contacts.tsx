 ...
 * Почта — строкой под ним, мельче: она вернулась 29.08, когда появился
 * настоящий адрес. Пока его не было, канала не показывали вовсе — канал, по
 * которому некому ответить, хуже отсутствия канала. Адреса идут компактным
 * блоком следом, реквизиты убраны в раскрывающийся блок и по умолчанию
 * свёрнуты. Карта — невысокая полоса во
      ...
      <div className="shell">
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-7">
            ...
            {/* Почта мельче телефона и без иконки: она второй канал, а не
                первый. Цель нажатия поднята полем, как у телефона в подвале:
                строка сама по себе ниже нормы в 44 px. */}
            <a
              href={`mailto:${COMPANY.email}`}
              className="link-underline tap-y tap-phone mt-4 inline-block rounded text-t2 font-medium text-ink-2 transition-colors duration-300 hover:text-accent"
            >
              {COMPANY.email}
            </a>
