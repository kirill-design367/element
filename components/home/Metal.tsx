      ...
      <div className="order-2 lg:order-1 lg:col-span-6 lg:flex lg:flex-col lg:justify-center">
        <div className="narrow narrow-left lg:max-w-none lg:pr-10">
          ...
          <p className="mt-4 max-w-[46ch] text-t2 leading-relaxed text-ink-2">
            {typo(
              /* «Напишите» заменено на «оставьте заявку»: почта с сайта убрана, и
                 глагол читался бы как приглашение написать письмом. Смысл и
                 длина те же, кнопка карточки и так ведёт в заявку. */
              'Помимо инертных материалов возим металлопрокат. Номенклатуру собираем, цену считаем по запросу — оставьте заявку, и мы ответим сроком и стоимостью.',
            )}
          </p>
