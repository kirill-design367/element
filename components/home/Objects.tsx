 ...
 *
 * Строка списка подсвечивается при наведении и по :focus-visible — это всё,
 * что их связывает. Смена кадра при наведении убрана: снимок один на все
 * четыре объекта, и менялся только кроп — приём изображал связь, которой
 * нет. Кадр теперь просто едет внутри неподвижной рамки по прокрутке.
 * Придут четыре отдельных снимка — смену можно будет вернуть, уже честную.
 */
