    ...
    <div>
      <div className="shell py-8 md:py-14">
        ...
        <p className="mt-3 max-w-[64ch] text-[16px] leading-relaxed text-ink-2 md:text-[17px]">
          Выбран третий вариант — три гарнитуры CoFo от Contrast Foundry. Он стоит на сайте и
          набран здесь собой. Первые два оставлены как отвергнутые кандидаты: они грузятся только
          этим маршрутом и в общий бандл не попадают.
        </p>
