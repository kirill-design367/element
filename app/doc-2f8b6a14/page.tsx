    ...
    <>
      ...
      <div className="dl">
        <div className="dl-card">
          ...
          <p>
            Один лист A4: визитка сверху, реквизиты снизу. Готовый файл — по
            кнопке слева. Правая кнопка открывает диалог печати браузера, если
            удобнее распечатать прямо отсюда.
          </p>
