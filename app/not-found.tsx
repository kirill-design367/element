    ...
    <Section tone="bg" width="shell" pad="loose">
      <div className="max-w-[720px]">
        ...
        {/* Числа считаются из данных, а не набраны: правило проекта.
            Строка идёт через typo(), а НЕ через nbsp(): nbsp склеивает
            неразрывными ВСЕ пробелы, и на 390 эта фраза распирала страницу
            вбок на 104 px — обход поймал. nbsp — для единиц и телефона, где
            слов два-три, а не для предложения. */}
