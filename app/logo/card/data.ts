...
export const CONTACTS = {
  ...
  site: COMPANY.site,
  /** Почта. Вернулась 29.08 вместе с настоящим адресом. */
  email: COMPANY.email,
};
...
/**
 * Реквизиты. Почты здесь нет намеренно: она контакт, а не реквизит, и стоит
 * на синей плашке рядом с телефоном. Заводить её сюда вторым местом
