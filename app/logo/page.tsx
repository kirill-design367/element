...
export const metadata: Metadata = {
  ...
  description:
    'Служебная страница выбора: пятнадцать отрисовок по трём направлениям, каждая в двух наборах слова, трёх палитрах и шести состояниях.',
    ...
    <div>
      ...
      <div className="shell py-8 pt-24 md:py-14 md:pt-28">
        ...
        <p className="mt-3 max-w-[64ch] text-[16px] leading-relaxed text-ink-2 md:text-[17px]">
          Направления выбраны, придумывать новые не нужно. По каждому — пять отрисовок, и
          отличаются они пропорциями, а не замыслом. Каждая показана в трёх парах красок и в двух
          наборах слова: прописными — во всех шести состояниях, включая проверку на фотографии
          первого экрана, набором из шапки сайта — в первых трёх. Состояния 4–6 проверяют форму, а
          не набор, и на втором наборе повторяли бы сами себя.
        </p>
        <p className="mt-3 max-w-[64ch] text-[16px] leading-relaxed text-ink-2 md:text-[17px]">
