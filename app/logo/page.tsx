      ...
      <div className="shell py-8 pt-24 md:py-14 md:pt-28">
        ...
        <section className="mt-12 rounded-card border border-line bg-surface p-5 shadow-card md:mt-16 md:p-8">
          ...
          <p className="mt-4 max-w-[70ch] text-[16px] leading-relaxed text-ink-2 md:text-[17px]">
            A4 книжной ориентации, 210×297 мм: печатается на обычном принтере и читается с
            телефона. Логотип берётся тем же кодом, что и вариации выше; состав, характеристики,
            пороги, сроки и реквизиты — из файлов данных сайта, руками не набрано ни одно число.
          </p>
