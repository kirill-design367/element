    ...
    <>
      ...
      <Section id="raschet" tone="muted" width="shell" pad="normal">
        {/* Обёртка max-w-[46ch] отсюда снята: она резала колонку до ~380 px,
            и заголовок «Расчёт стоимости с доставкой» вставал в три строки.
            Ограничение было нужно пояснению, а у него свой предел в 54 знака
            внутри SectionHead. Заголовку дана полная ширина — на десктопе он
            встаёт в одну строку, на 1512 и уже переносится сам. */}
