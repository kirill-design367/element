...
# Восемь отрисовок. Отличаются пропорциями, не идеей: глубина фаски, длина
# плеч (она же — сколько букв накрывает скоба), вес скобы, поля плашки.
MARKS = [
    ('l1', dict(ch=0.14, arm_top=0.62, arm_bot=0.30, sb=1.00, pad=0.42, gy=0.22)),
    ('l2', dict(ch=0.06, arm_top=0.62, arm_bot=0.30, sb=1.00, pad=0.42, gy=0.22)),
    ('l3', dict(ch=0.33, arm_top=0.62, arm_bot=0.30, sb=1.00, pad=0.42, gy=0.22)),
    ('l4', dict(ch=0.14, arm_top=0.44, arm_bot=0.44, sb=1.00, pad=0.42, gy=0.22)),
    ('l5', dict(ch=0.14, arm_top=0.30, arm_bot=0.62, sb=1.00, pad=0.42, gy=0.22)),
    ('l6', dict(ch=0.14, arm_top=0.28, arm_bot=0.14, sb=1.00, pad=0.42, gy=0.22)),
    ('l7', dict(ch=0.14, arm_top=0.62, arm_bot=0.30, sb=0.86, pad=0.42, gy=0.22)),
