...
SOURCES = [
    ...
    #
    # Кандидатов здесь больше нет. Golos Text, Unbounded и Tektur стояли тут
    # ради страницы сравнения /fonts; страница удалена, и вместе с ней ушли
    # и собранные woff2. Механизм осей остался рабочим: понадобится сравнить
    # новую гарнитуру — строка добавляется сюда, исходник берётся из папки,
    # переданной первым аргументом.
]
