...
#   анонс металла      — 840 / 1400 / 2200 широкий, 560 / 840 / 1120 узкий
PLAN = {
    ...
    # Анонс металлопроката: широкий кадр занимает правую половину карточки и
    # уходит за правый край экрана, поэтому ширины крупнее половины экрана;
    # вертикальный показывается на телефоне во всю ширину.
    'metal': [840, 1400, 2200],
    'metal-mobile': [560, 840, 1120],
}
