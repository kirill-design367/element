 ...
 *
 * Имя сбивает с толку, и это стоило одного разбирательства: файл лежит
 * внутри корня сайта, называется config.php — и читается как «пароли в
 * открытом доступе». Внутри же только код, который ИЩЕТ настоящий файл
 * настроек и подключает его по абсолютному пути.
 *
